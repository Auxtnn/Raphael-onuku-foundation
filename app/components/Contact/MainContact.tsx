        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p style={{ color: "#4B5563" }}>
                    raphaelonukufoundation@outlook.com
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p style={{ color: "#4B5563" }}>
                    No. 23, Dan Asogwa Crescent Street, Eburummiri, Nsukka,
                    Enugu State, Nigeria
                  </p>
                </div>
              </div>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://facebook.com/raphaelonukufoundation"
                  target="_blank"
                ...
                <a
                  href="https://twitter.com/rof_nigeria"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full flex items-center justify-center text-white"
                  style={{ backgroundColor: "#1075BB" }}
                ...
                <a
                  href="https://instagram.com/raphaelonukufoundation"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full flex items-center justify-center text-white"
                  style={{ backgroundColor: "#1075BB" }}
                ...
                <a
                  href="https://linkedin.com/company/raphael-onuku-foundation"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full flex items-center justify-center text-white"
                  style={{ backgroundColor: "#1075BB" }}
          ...
          <div className="lg:col-span-8">
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              {submitError && (
                <div className="mb-6 p-4 rounded-lg text-white bg-red-500">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="px-6 py-3 rounded-lg text-white font-medium transition-all duration-300 flex items-center justify-center"
                  style={{ backgroundColor: "#1075BB" }}
