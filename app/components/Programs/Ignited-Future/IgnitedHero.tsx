  ...
  return (
    <section ref={ref} className="relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/assets/images/hero-comm.png"
          alt="IgnitedFuture Community members"
          fill
      ...
      <div className="container mx-auto px-4 relative lg:w-11/12">
        <div className="min-h-[60vh] flex flex-col justify-center py-20">
          <div className="max-w-3xl">
            ...
            >
              A mentorship forum dedicated to making scholarship opportunities
              accessible for Nigerian youth through guidance, coaching, and peer
              support.
            </motion.p>
